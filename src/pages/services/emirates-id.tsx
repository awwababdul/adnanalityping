...
import { ArrowLeft, FileSignature, UserCheck, FileCheck } from "lucide-react";
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bold text-white mb-6">
              <span className="text-gradient">Emirates ID Services</span>
            </h1>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <h2 className="text-4xl font-bold mb-8">
              <span className="text-gradient">Ready to get your Emirates ID?</span>
            </h2>
            <p className="text-gray-600 text-lg mb-8">
              Our team will handle your Emirates ID application with speed and efficiency.
            </p>
            <Button
